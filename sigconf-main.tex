...
The conceptual framework of social media by Carr and Hayes \cite{Carr2015} identifies three main reasons why mindless scrolling occurs easily: disentrainment (asynchronous communication), persistence (unlimited content), and perceived interactivity. The combination of these factors encourages even passive users to keep consuming content endlessly and without clear goals. Such conditions create a behavioral loop that extends screen time and reduces sustained attention.

This theoretical understanding, supported by the explanation from Sinha et al. \cite{Sinha2023}, illustrates how the infinite scroll design triggers the dopaminergic reward system and establishes automatic habits. Continuous dopamine activity leads to dopamine tolerance, where users require stronger stimuli to experience the same level of satisfaction. This process then creates cognitive fatigue, reducing the efficiency of working memory and slowing information processing speed. In the long term, this condition impairs the brain’s ability to maintain focus for extended periods and diminishes responses to basic stimuli, potentially affecting users’ reaction times in daily activities.

De Segovia Vicente et al. \cite{deSegovia2024} support these findings with evidence from an experience-sampling approach and behavioral log data. Their study also shows that mindless scrolling leads to conflicts between intentions and actions (goal conflict), resulting in decreased attention quality and daily cognitive performance. These findings indicate that focus degradation is not only situational but may also reflect a shift in attention habits caused by repeated exposure to rapid stimulation patterns in interface design.

Sinha et al. \cite{Sinha2023} further explain that endless scrolling activities create working memory overload and disrupt the brain’s natural segmentation processes for organizing and storing information. Users exposed to infinite scroll tend to read more but understand less, as the brain lacks the time needed to fully consolidate information. In contrast, page layouts or designs with stopping cues help users reset focus, improve spatial orientation, and enhance information encoding into long-term memory. In the context of human performance, this means that limitless designs such as infinite scroll interfaces degrade the accuracy and speed of reactions to subsequent stimuli due to attention fragmentation.

Experimental research conducted by Ruiz et al. \cite{Ruiz2024} makes an essential contribution by introducing the concept of design friction—small, intentional elements of difficulty added to an interface to create cognitive breaks. In the context of mindless scrolling, friction slows the rhythm of interaction and restores the user’s awareness of their activity. This study compared two versions of a fictional social media interface: one with infinite scroll (control) and another with a reaction-based design, where users must respond before viewing the next post. The results show that the reaction-based interface improves memory for content and increases awareness and cognitive involvement. However, this increase in awareness was also accompanied by a decline in user satisfaction, suggesting that design interventions must balance attention and comfort.

Overall, the reviewed literature shows that mindless scrolling behavior arises from the combination of platform interfaces that remove interaction boundaries, neurobiological responses to quick gratification, and cognitive mechanisms that reinforce repetitive habits. The effects not only cause a temporary decline in focus and memory but may also slow reactions to basic stimuli due to adaptation to high-frequency stimulation. In the HCI context, this research emphasizes the importance of user-interface design that can maintain the user’s attention rhythm, enhance situational awareness, and prevent users from falling into a compulsive interaction cycle.

This literature review underscores the need for continued research that empirically tests how mindless scrolling affects reaction time and visual focus in daily interactions. Such experimental approaches to measuring cognitive performance would make an essential contribution by bridging the subjective effects of mindless scrolling with objective indicators of human performance within the HCI context.
