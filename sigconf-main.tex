...
While Sinha et al. \cite{Sinha2023} highlight the neurocognitive mechanisms underlying attentional overload, Hanna \cite{Hanna2022} extends the discussion by introducing the concept of Time Confetti, as proposed by Whillans. Time Confetti describes time as fragmented into numerous small, random intervals that erode temporal coherence. In digital contexts, this phenomenon illustrates how online activities, notifications, and mindless scrolling divide an individual’s time into microfragments, compromising the ability to focus or rest effectively. Hanna attributes this temporal fragmentation to three primary factors: constant notifications and interruptions, algorithmic recommendation systems, and micro-interaction designs such as stories, reels, and continuous scroll loops. These features fragment an individual’s attention within minutes, progressively reducing cognitive capacity. Time Confetti is closely linked to design mechanisms that amplify addictive engagement by stimulating the dopaminergic system, creating a craving-loop behavior that diminishes dopamine sensitivity and long-term concentration.
